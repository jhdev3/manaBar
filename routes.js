...
router.get('/booking/array', (req, res) => {
    if(req.query.token == "12312312378126asd1237123hajsdkj81238"){ //Kollar behöverighet säker nät
...
//post req.body."name" fungerar i post inte i get xD
router.post('/booking/send/bord', (req, res) => {
    res.send('lyckad post'); //Inte svenska bokstäver med res.end men med res.send kmr köra express resten av kursen
  
  });

router.post('/booking/send/dator', (req, res) => {
    res.send('lyckad post'); //Inte svenska bokstäver med res.end men med res.send kmr köra express resten av kursen
